...
const routes: Routes = [
  ...
  { path: 'editar-productos', loadChildren: () => import('./pages/supermercado/editar-productos/editar-productos.module').then(m => m.EditarProductosModule) , canActivate : [ProductosGuard] , data: { expectedRol: ['admin', 'user'] }},

  { path: 'agregar-productos', loadChildren: () => import('./pages/supermercado/agregar-productos/agregar-productos.module').then(m => m.AgregarProductosModule) , canActivate : [ProductosGuard] , data: { expectedRol: ['admin', 'user'] } },
