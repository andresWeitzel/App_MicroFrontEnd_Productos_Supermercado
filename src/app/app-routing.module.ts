...
const routes: Routes = [
  ...
  { path: 'lista-productos', loadChildren: () => import('./pages/supermercado/lista-productos/lista-productos.module').then(m => m.ListaProductosModule) , canActivate : [ProductosGuard] },
  ...
  { path: 'agregar-productos', loadChildren: () => import('./pages/supermercado/agregar-productos/agregar-productos.module').then(m => m.AgregarProductosModule) },
